...
class Build implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['deploy_to'] = isset($data['deploy_to']) ? $data['deploy_to'] : null;
    ...
    {
        return $this->container['deploy_to'];
    }

    /**
     * Sets deploy_to
     * @param string $deploy_to Where the deployment should go.
     * @return $this
     */
    public function setDeployTo($deploy_to)
    {
        $this->container['deploy_to'] = $deploy_to;
